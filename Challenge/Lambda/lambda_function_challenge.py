    ...
    if age is not None:
        ...
        if age < 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "You should be at between 0 and 65 years old to use this service. "
...
def recommend_portfolio(intent_request):
    ...
    #message = f"You should invest in {risk_levels.get(risk_level} for risk level {risk_level}."    
    
    #HARDCODING AS LEX WILL NOT RETRIEVE THE VALUE FROM THE DICTIONARY
    message = f"You should invest in 60% bonds (AGG), 40% equities (SPY) for risk level {risk_level}."   
